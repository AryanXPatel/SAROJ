        ...
        <div className="w-full max-w-md">
          <Card className="border-rose-100 shadow-lg">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl font-serif text-rose-900">Welcome Back</CardTitle>
              <p className="text-rose-700">Sign in to your account to continue shopping</p>
            </CardHeader>
            <CardContent className="space-y-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center space-x-2">
                    ...
                    />
                    <span className="text-sm text-rose-700">Remember me</span>
                  </label>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-white px-2 text-rose-600">Or continue with</span>
                </div>
              </div>
